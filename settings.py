...
DEFAULT_DB_DBUSER = os.getenv('DEFAULT_DB_DBUSER', 'codo')   #修改
DEFAULT_DB_DBPWD = os.getenv('DEFAULT_DB_DBPWD', 'Admin@123.com') #修改
...
READONLY_DB_DBUSER = os.getenv('READONLY_DB_DBUSER', 'codo') #修改
READONLY_DB_DBPWD = os.getenv('READONLY_DB_DBPWD', 'Admin@123.com') #修改
...
CODO_TASK_DB_USER = os.getenv('CODO_TASK_DB_USER', 'codo') #修改
CODO_TASK_DB_PWD = os.getenv('CODO_TASK_DB_PWD', 'Admin@123.com') #修改
